...
{% hint style="warning" %}
‎This wiki is made to explain the plugin as of version 2.1.9. If any of the config here is missing on your plugin, make sure your plugin is up-to-date, the plugin says when its up-to-date on its starts.
{% endhint %}
